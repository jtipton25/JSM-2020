...
## Large databases of pollen data
...
- Due to challenging data likelihood (compositional count data).
...
- Compositional count data.
    ...
    * Total count is not informative of the process of interest. 
...
* $\mathbf{y}(\mathbf{s}, t)$ is informative of the relative proportions $\pi_{SB}(\boldsymbol{\eta}(\mathbf{s}, t))$ only.
...
<font size="3">
@polson2013bayesian, @linderman2015dependent
</font>
...
## Process Model -- $\color{red}{\mbox{fixed effects}}$
